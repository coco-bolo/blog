                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="td-manage">
                                        ...
                                        <!-- <a title="授权" onclick="xadmin.open('授权','{{ url("admin/role/" . $role->id . "/auth") }}',600,400)" href="javascript:;">
                                            <i class="layui-icon layui-icon-auz"></i>
                                        </a> -->
                                        <a title="编辑" onclick="xadmin.open('编辑','{{ url("admin/role/" . $role->id . "/edit") }}',600,400)" href="javascript:;">
                                            <i class="layui-icon">&#xe642;</i>
                                        </a>
...
<script>
    ...
    function member_del(obj, id) {
        layer.confirm('该角色删除后，所有权限也将被清空！确认要删除吗？', function(index) {
            //发异步删除数据
            $.ajax({
                url: '/admin/role/' + id,
                method: 'delete',
