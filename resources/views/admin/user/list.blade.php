                    ...
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5">
                                ...
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" name="username" placeholder="请输入用户名" autocomplete="off" class="layui-input" value="{{ $request->input('username') }}">
                                </div>
                                <div class="layui-inline layui-show-xs-block">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td class="td-manage">
                                      ...
                                      <a title="编辑"  onclick="xadmin.open('编辑','{{ url("admin/user/" . $user->id . "/edit") }}',600,400)" href="javascript:;">
                                        <i class="layui-icon">&#xe642;</i>
                                      </a>
                        ...
                        <div class="layui-card-body ">
                            <div class="page">
                                {{ $users->appends($request->all())->onEachSide(1)->render() }}
                            </div>
                        </div>
                    </div>
                </div>
