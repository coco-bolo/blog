...
<body>
            ...
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 500px;">
                        <input type="text" name="title" lay-verify="title" autocomplete="off" class="layui-input" value="{{$article->title}}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="editor" lay-verify="editor" autocomplete="off" class="layui-input" value="{{$article->editor}}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="tag" lay-verify="tag" autocomplete="off" class="layui-input" value="{{$article->tag}}">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <img id="thumb_img" src="http://{{env('QINIU_DOMAIN')}}/{{$article->thumb}}">
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="请输入" name="desc" class="layui-textarea" style="height: 150px;">{{$article->desc}}</textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <!-- 隐藏域2 -->
                    <input name="content" type="hidden" id="content" value="{{$article->content}}" >
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"></label>
                    <button lay-submit class="layui-btn" lay-filter="edit">修改</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        layui.use(['form', 'layer', 'upload'], function() {
            ...
            // editor.txt.html('<h2>lalala</h2><p>我爱gar噶啊纷扰</p><br><h3>3141af</h3>')
            $ = layui.jquery;
            var form = layui.form,
                layer = layui.layer,
                upload = layui.upload;
